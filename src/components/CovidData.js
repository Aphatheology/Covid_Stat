...
import { loadstats } from "../store/covidstat";
import { useEffect } from "react";

const CovidData = () => {
    const dispatch = useDispatch();
    let stats = useSelector((state) => state.list);
                    ...
                    <div className="stat-container">
                        <div className="each-stat">
                            ...
                            <div>
                                ...
                                <h3>{stats.data.totalSamplesTested}</h3>
                            </div>
                        </div>
                        ...
                        <div className="each-stat">
                            ...
                            <div>
                                ...
                                <h3>{stats.data.totalConfirmedCases}</h3>
                            </div>
                        </div>
                        ...
                        <div className="each-stat">
                            ...
                            <div>
                                ...
                                <h3>{stats.data.totalActiveCases}</h3>
                            </div>
                        </div>
                    ...
                    <div class="data-table">
                        ...
                        <div class="table">
                            ...
                            <th>action</th> */}
                                ...
                                <tbody>
                                    {stats.data.states.map((eachState) => {
                                        <>
                                            <tr key={eachState._id}>
                                                ...
                                                <td>
                                                    {" "}
                                                    {
                                                        eachState.confirmedCases
                                                    }{" "}
                                                </td>
                                                <td>
                                                    {" "}
                                                    {
                                                        eachState.casesOnAdmission
                                                    }{" "}
                                                </td>
                                                <td>
                                                    {" "}
                                                    {eachState.discharged}{" "}
                                                </td>
